...
/* package jmp-0.1.0.0 */
#ifndef VERSION_jmp
#define VERSION_jmp "0.1.0.0"
#endif /* VERSION_jmp */
#ifndef MIN_VERSION_jmp
#define MIN_VERSION_jmp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_jmp */
...
#define CURRENT_COMPONENT_ID "jmp-0.1.0.0-inplace-jmp"
